...
### [Variable definitions](http://graphql.org/learn/queries/#variable-definitions)
...
### [Default variables](http://graphql.org/learn/queries/#default-variables)
...
### [Multiple fields in mutations](http://graphql.org/learn/queries/#multiple-fields-in-mutations)
...
Like many other type systems, GraphQL schemas include the ability to define interfaces and union types. [Learn about them in the schema guide](http://graphql.org/learn/schema/#interfaces).
...
GraphQL services provide a few meta fields, the rest of which are used to expose the [Introspection](http://graphql.org/learn/introspection/) system.